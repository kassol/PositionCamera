...
- (void)viewDidLoad {
    ...
    self.tableView1.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.9];
    self.tableView2.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.9];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (tableView == _tableView1) {
        CustomTableViewCell* cell = (CustomTableViewCell *)[self.tableView1 dequeueReusableCellWithIdentifier:@"LeftCell"];
        if (cell == nil) {
            cell = [[CustomTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"LeftCell"];
    ...
    {
        CustomTableViewCell* cell = (CustomTableViewCell *)[self.tableView2 dequeueReusableCellWithIdentifier:@"RightCell"];
        if (cell == nil) {
            cell = [[CustomTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"RightCell"];
    ...
    if (item.isSubItem) {
        ...
        [_camera setCameraRecordingResolution:_resolutionType andFOV:_fovType withResultBlock:^(DJIError *error) {
            ...
            if (error.errorCode == ERR_Successed) {
                ...
                NSLog(@"Set RecodingResolution Failed:(%lu)", (unsigned long)error.errorCode);
            }
